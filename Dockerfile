...
ENV WEBLATE_SECURE_PROXY_SSL_HEADER=HTTP_X_FORWARDED_PROTO,https
...
ENV CELERY_MAIN_OPTIONS="--queues=celery,notify,memory,translate,backup \
                         --pool=prefork --concurrency=1 --prefetch-multiplier=1 --max-tasks-per-child=50"
